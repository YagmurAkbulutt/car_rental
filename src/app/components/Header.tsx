...
<nav className="text-sm md:text-base flex gap-2 md:gap-4">
    ...
    <Link href={"/home"} className="max-md:hidden">Fiyatlandırma</Link>
    <Link href={"/home"}>Hakkımızda</Link>
</nav>

<div className="flex gap-5 ">
    <button className="max-md:hidden">İletişim</button>
    <button className="bg-white text-black rounded-full px-5 py-2 text-nowrap transition hover:bg-gray-100">Giriş Yap</button>
</div>
        </Container>
    </header>
  )
