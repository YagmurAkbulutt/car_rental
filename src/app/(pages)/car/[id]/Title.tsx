...
const Title = ({car} : {car : Car}) => {
  ...
  return (
    <div className='mt-10 flex justify-between'>
        <div>
            <h1 className='font-bold text-3xl md:text-4xl'>{car.make} {car.model}</h1>

            <div className='flex gap-5 mt-5'>
                {arr.map((item) => (
                    <div key={item.name} className='py-1 px-3 rounded-md bg-blue-500/20 flex gap-1 items-center md:mb-5'>
